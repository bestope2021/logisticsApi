...
class LeTian extends LogisticsAbstract implements BaseLogisticsInterface, PackageLabelLogisticsInterface, TrackLogisticsInterface
{
    /**
     * 一次最多提交多少个包裹,5自定义
     */
...
//        $this->dd($res);
    ...
    public function getPackagesLabel($params = [])
    {
        $data = [
            'printOrderRequest' => [
                'oid' => implode(',', $this->toArray($params['syOrderNo'])),
