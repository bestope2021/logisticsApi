...
class DgDhl extends LogisticsAbstract implements BaseLogisticsInterface, PackageLabelLogisticsInterface, TrackLogisticsInterface
{
    /**
     * 一次最多提交多少个包裹,5自定义
     */
    ...
    public function createOrder(array $params = [])
    {
        ...
        foreach ($params as $item) {
            ...
            $shipper = [
                ...
                'RegistrationNumbers' => $item['senderTaxNumberIssuerCountryCode'] ? $shipperRegistrationNumbers : '',
